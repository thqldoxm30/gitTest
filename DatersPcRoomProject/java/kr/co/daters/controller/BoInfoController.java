...
public class BoInfoController {
	...
	@RequestMapping(value = "/AllBranchInfo.do")
	public String AllBranchInfo(Model model) {
		List<BoInfoVO> BranchList = boInfoDAO.selectAllBoOrder();
		model.addAttribute("BranchInfoList", BranchList);
		return "Other/MainBranch"; //메인으로 이동하게 해야함
	}
